...
function showtext3(){
    texto.innerHTML = 'Transformar o jovem em situação de vulnerabilidade num agente social protagonista da sua história'
}
...
function showconquist2(){
    sumirtextconquista.innerHTML = '';
    sumirdescrconquista.innerHTML = '';
    showresult.innerHTML = 'Conseguimos mobilizar 90 comunidades com o projeto em sua íntegra de conteúdo e possibilidade de sustentação de aprendizado de modo geral!';
}
...
function showconquist4(){
    sumirtextconquista.innerHTML = '';
    sumirdescrconquista.innerHTML = '';
    showresult.innerHTML = 'Conseguimos um espaço de vez e voz em parceria com o InovaBra Habitat, conseguindo assim mais espaço de fala para cada um de nós!';
}
